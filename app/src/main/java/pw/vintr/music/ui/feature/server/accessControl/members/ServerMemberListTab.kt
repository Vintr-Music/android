...
import pw.vintr.music.ui.kit.server.member.ServerMemberCard

@OptIn(ExperimentalMaterialApi::class)
@Composable
fun ServerMemberListTab(
    serverId: String,
    viewModel: ServerMemberListViewModel = koinViewModel { parametersOf(serverId) }
) {
        ...
        PullRefreshLayout(
            ...
            LazyColumn(
                ...
                items(
                    ...
                    ServerMemberCard(
                        member = member,
                        onClick = { viewModel.openMemberDetails(member) }
                    )
                }
            }
        }
